  ...
  >
    <template v-slot:top>
      <v-toolbar
        flat
      >
        <v-toolbar-title style="margin-right:150px">Proveedores</v-toolbar-title>
        <spacer></spacer> 
        <!-- barra buscar -->
...
export default {
    data(){
        return{
            ...
            tiposDocumento:['CC', 'NIT', 'PASAPORTE', 'CE'],
            id: "",
            dialog: false,
            dialogActivar: false,
            bd: 0,
    ...
    methods: {
        listarProveedores(){
            ...
            axios
                .get("persona/listProveedores/proveedor", header)
                .then((response) =>{
